        ...
        <div className="mt-6 sm:mt-8 p-4 sm:p-6 bg-muted/50 rounded-lg border border-border">
          ...
          <div className="space-y-2 text-xs sm:text-sm">
            <div className="break-all">
              ...
              <span className="text-muted-foreground sm:ml-2 block sm:inline">- Retrieve prompt as JSON</span>
            </div>
            <div className="break-all">
              <span className="text-muted-foreground">POST </span>
              <code className="px-2 py-1 bg-background rounded text-foreground">/api/prompt</code>
              <span className="text-muted-foreground sm:ml-2 block sm:inline">- Update prompt</span>
            </div>
          </div>
        </div>
      </div>
